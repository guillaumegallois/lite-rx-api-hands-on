...
//========================================================================================
	...
	void expectFooBarComplete(Flux<String> flux) {
		StepVerifier.create(flux)
				...
				.expectComplete()
				.verify();
		// "verifyComplete()" ou "expectComplete().verify()"
	}
...
//========================================================================================
	...
	void expectFooBarError(Flux<String> flux) {
		StepVerifier.create(flux)
				...
				.verify();
		// "verifyError()" ou ".expectError(RuntimeException.class).verify()"
	}
...
//========================================================================================
	...
	void expectSkylerJesseComplete(Flux<User> flux) {
		StepVerifier.FirstStep<User> sv = StepVerifier.create(flux);
		sv
...
//========================================================================================
	...
	void expect10Elements(Flux<Long> flux) {
		StepVerifier.FirstStep<Long> sv = StepVerifier.create(flux);
		Duration duration = sv.expectNextCount(10).verifyComplete();
